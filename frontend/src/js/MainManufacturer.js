import "../css/MainManufacturer.css";
  ...
  return (
    <Container>
      ...
      <Row>
        ...
        <Col>
          <Button id="buttons" onClick={() => setOwner(false)}><b>Join Contract</b></Button>
        </Col>
    ...
    <Row>
    <h5><i> Information about supplier of raw materials:</i> </h5>

    <Table id="table1" striped bordered hover variant="danger">
      <thead>
        <tr>
          <th></th>
          <th>Name of supplier</th>
          <th>Country of origin</th>
          <th>Information of supplier</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          ...
          <td>DAM</td>
          <td>Italy</td>
          <td>We have 11 regional offices and more than 500 employees in Europe,
          DAM Europe supplies small and medium-sized customers from a wide variety of industries with about 6,000 products.</td>
        </tr>
        <tr>
          <td>2</td>
          <td>MAK</td>
          <td>France</td>
          <td>We sell leftover stocks, surplus stocks, sample collections of well-known fashion brands. All products are genuine, A-grade and brand new with their original tags on.
             We buy our garments directly from European distributors and always make sure that the quality of the products is impeccable. </td>
        </tr>
    ...
    <br />
    <Row>
    <h5><i> Information about control agencies for product testing:</i> </h5>

    <Table id="table2" striped bordered hover variant="danger">
      <thead>
        <tr>
          <th></th>
      ...
      <tbody>
        <tr>
          <td>1</td>
          <td>Fashion inspect</td>
          <td>Boston</td>
          <td>Publisher Development,Consultancy,Migrations</td>
        </tr>
        <tr>
          <td>2</td>
          <td>Control partner</td>
          <td>London</td>
          <td>Publisher Development,Consultancy,Migrations,Global/Regional Management,Compliance & Fraud Monitoring </td>
        </tr>
